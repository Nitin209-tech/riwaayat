...
export default function Coins() {
  ...
  const rewards = [
    ...
    // New Event Rewards
    { key: 'nitrobasic1m', cost: 30000000, name: 'Nitro Basic (1 month)', type: 'nitro', inrPrice: '₹499/mo', desc: 'Discord Nitro Basic for 1 month. 2 invites required.', icon: '💎', badge: 'Basic 1M', badgeStyle: 'rgba(88,101,242,0.1)' },
